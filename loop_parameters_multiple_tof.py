...
import jp_graph_trial_multiple_tof as jp
...
ground_truth_date = "01_10"
ground_truth_time = "14_56"
...
DATA_INPUT = PATH + "ground_truth_realistic/"+ ground_truth_date +"/multiple_tof_"+ground_truth_time+".json"


results = []

with open(DATA_INPUT) as side_a:
	a = json.load(side_a)
with open(DATA_INPUT) as side_b:
	b = json.load(side_b)
